 ...
 * BrandCard — top-level
 * ──────────────────────────────────────────────────────────── */
export function BrandCard({ data, mode = 'display', size = 'default', onPaletteNameChange, onPaletteMainChange, onRungOverride, onNeutralHueModeChange, onGradientNameChange, onSemanticChange, className, }) {
