...
export declare function BrandCard({ data, mode, size, onPaletteNameChange, onPaletteMainChange, onRungOverride, onNeutralHueModeChange, onGradientNameChange, onSemanticChange, className, }: BrandCardProps): import("react/jsx-runtime").JSX.Element;
