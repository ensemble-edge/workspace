...
export const Wordmark = React.forwardRef(({ segments, imageUrl, name, alt, imageHeight = 32, className, ...rest }, ref) => {
    ...
    if (segments && segments.length > 0) {
        ...
        return (_jsx("span", { ref: ref, className: cn("inline-flex items-baseline tracking-tight", className), style: wrapStyle, "aria-label": name, ...rest, children: segments.map((s, i) => (_jsx("span", { style: s.color ? { color: s.color } : undefined, children: s.text }, i))) }));
    }
    if (imageUrl) {
