 ...
 */
export type Permission = 'read:user' | 'read:workspace' | 'read:members' | 'write:members' | 'read:settings' | 'write:settings' | 'read:brand' | 'write:brand' | 'emit:events' | 'read:audit' | 'storage:read' | 'storage:write' | 'ai:invoke' | string;
/**
 ...
 */
export declare const ENSEMBLE_HEADERS: {
    readonly WORKSPACE_ID: "X-Ensemble-Workspace-Id";
    readonly USER_ID: "X-Ensemble-User-Id";
    readonly USER_EMAIL: "X-Ensemble-User-Email";
    readonly USER_ROLE: "X-Ensemble-User-Role";
    readonly APP_ID: "X-Ensemble-App-Id";
    readonly CAPABILITY_TOKEN: "X-Ensemble-Capability-Token";
    readonly REQUEST_ID: "X-Ensemble-Request-Id";
};
