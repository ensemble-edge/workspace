...
export const migration = {
    name: '011_ai_tier_provider',
    sql: `ALTER TABLE workspace_ai_tiers ADD COLUMN provider TEXT NOT NULL DEFAULT 'custom';`,
};
//# sourceMappingURL=011_ai_tier_provider.js.map