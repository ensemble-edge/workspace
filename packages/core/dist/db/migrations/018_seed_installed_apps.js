...
const inserts = CORE_APP_IDS.map((id) => `INSERT OR IGNORE INTO installed_apps (workspace_id, app_id, manifest_json, settings_json, status)
       SELECT id, '${id}', '{}', '{}', 'active' FROM workspaces;`).join('\n');
