...
import { renderInviteEmail, renderPasswordResetEmail, } from '../services/email-templates.js';
...
import { listLocales, addLocale, patchLocale, setDefaultLocale, removeLocale, } from '../services/locales.js';
...
export function createCredentialsRoutes() {
    ...
    const SETTING_KEYS = ['session_ttl_seconds'];
