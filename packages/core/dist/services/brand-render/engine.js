 ...
 */
export function ensureRenderEngineReady() {
    if (!resvgReady) {
 ...
 */
export async function renderToSvg(node, opts) {
    const satoriOpts = {
        width: opts.width,
        height: opts.height,
        fonts: opts.fonts,
    ...
    return await satoriImport(node, satoriOpts);
}
/**
 ...
 */
export async function renderToPng(svg, width) {
