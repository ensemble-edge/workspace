...
async function sendViaCloudflare(env, _workspaceId, msg, fromAddress) {
    if (!env.SEND_EMAIL) {
        return {
            ...
            error_detail: 'Cloudflare Email Sending requires a [[send_email]] binding in your wrangler.toml. ' +
    ...
    try {
        ...
        const messageId = sendResult && typeof sendResult === 'object' && 'messageId' in sendResult
