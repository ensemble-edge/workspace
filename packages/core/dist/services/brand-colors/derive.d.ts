 ...
 */
export declare function deriveNeutralRungs(mainHex: string): Record<Exclude<RungName, 'main'>, string>;
/**
 ...
 */
export declare function neutralMainOutOfRange(mainHex: string): boolean;
/**
 ...
 */
export declare function neutralMainFromHueMode(hueMode: 'branded' | 'warm' | 'cool' | 'true' | 'custom', primaryMainHex: string): string;
/**
