...
export type SettingKey = 'session_ttl_seconds' | 'asset_public_alias_path' | 'public_brand_guide_enabled' | 'r2_selected_bucket' | 'r2_binding_name' | 'legal.company_name' | 'legal.business_address' | 'legal.support_email' | 'legal.support_phone' | 'legal.notices_email' | 'legal_public_enabled' | 'legal_allow_indexing';
