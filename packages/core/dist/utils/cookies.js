 ...
 * @returns Cookie header string
 */
export function setAccessTokenCookie(token, options = {}) {
 ...
 * @returns Cookie header string
 */
export function setRefreshTokenCookie(token, options = {}) {
 ...
 * @returns Cookie header string
 */
export function setWorkspaceCookie(workspaceSlug, options = {}) {
 ...
 */
export function clearAuthCookies(options = {}) {
    return [
 ...
 */
export function isSecureContext(url) {
    try {
 ...
 */
export function getCookieOptionsForEnv(env, requestUrl) {
