 ...
 */
export type StandaloneAuthProvider = 'email' | 'magic-link' | 'google' | 'github' | 'microsoft' | 'saml';
/**
 ...
 */
export type WorkspaceModeConfig = (BaseWorkspaceConfig & StandaloneModeConfig) | (BaseWorkspaceConfig & CloudModeConfig);
/**
 * Default auth headers used by Ensemble proxy.
 */
export declare const DEFAULT_CLOUD_AUTH_HEADERS: CloudAuthHeaders;
/**
 * Check if config is standalone mode.
 */
export declare function isStandaloneMode(config: WorkspaceModeConfig): config is BaseWorkspaceConfig & StandaloneModeConfig;
/**
 * Check if config is cloud mode.
 */
export declare function isCloudMode(config: WorkspaceModeConfig): config is BaseWorkspaceConfig & CloudModeConfig;
/**
 * Get resolved auth headers for cloud mode.
 */
export declare function getCloudAuthHeaders(config: BaseWorkspaceConfig & CloudModeConfig): CloudAuthHeaders;
/**
 ...
 */
export declare function detectModeFromEnv(env: Record<string, unknown>): DeploymentMode;
/**
 * Type guard to check if a value is a valid deployment mode.
 */
export declare function isValidDeploymentMode(value: unknown): value is DeploymentMode;
