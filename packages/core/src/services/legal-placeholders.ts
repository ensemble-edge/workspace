 ...
 */
export function substituteLegalPlaceholders(
  bodyMd: string,
 ...
 */
export async function resolveLegalPlaceholders(
  env: SettingsEnv,
  workspaceId: string,
  bodyMd: string,
  isoDate: string,
  ...
  const [companyName, businessAddress, supportEmail, supportPhone, noticesEmail] =
    await Promise.all([
  ...
  return substituteLegalPlaceholders(
    bodyMd,
    { companyName, businessAddress, supportEmail, supportPhone, noticesEmail },
    isoDate,
    locale,
  );
}
